...
export const StockMin = ({data}) => {
    ...
    return (
        <div className="w-full hover:bg-black hover:bg-opacity-15 p-2 border-b border-white border-opacity-10 text-white h-auto grid grid-cols-[10%_40%_10%_10%_10%_10%_10%]">
            ...
            <div className=" w-full h-full flex items-center justify-end text-opacity-80">${(last_price.toFixed(1))}</div>
